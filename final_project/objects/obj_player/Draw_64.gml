...
draw_sprite_part_ext(spr_healthbar_inside,1,0,0,((player_health/player_health_set)*256),64,40,20,1,1,c_white,1);
draw_sprite_ext(spr_healthbar_outside,1,40,20,1,1,0,c_white,1);
